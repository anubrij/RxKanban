...
function generateData(count) {
    ...
    for (i = 0; i < count; i++) {
        ...
        items.push(item);
        if (lanes.indexOf(item.lastName) == -1) {
            lanes.push(item.lastName)
        }
    }
    return {

        cards: items,
        lanes: lanes.map(l => { return { name: l } })
    };
}
(() => {
    const ds = generateData(1100);
                ...
                return {
                    ...
                    children: [{
                        ...
                        },
                        {
                            ...
                            children: [{
                                tag: "span",
                                innerHtml: card.firstName,
                                style: "color: #968e8e"
                            }, {
                                tag: "p",
                                className: "mb-0",
                                innerHtml: card.lastName,
                                style: "color: #4e4646"
                            }],
